...
export const zh_CN: Translation = {
	...
	// Steam 游戏库
	[Key.steam]: "Steam 游戏",
	[Key.steamRecentGames]: "最近玩过",
	[Key.steamGameLibrary]: "Steam 游戏库",
	[Key.steamLibrarySubtitle]: "记录我的 Steam 游戏之旅",
	[Key.steamViewFullLibrary]: "查看完整游戏库",
	[Key.steamHours]: "小时",
	[Key.steamMinutes]: "分钟",
	[Key.steamLastPlayed]: "最后游玩",
	[Key.steamNotPlayedRecently]: "最近未游玩",
	[Key.steamSortByPlaytime]: "按游戏时长",
	[Key.steamSortByName]: "按名称",
	[Key.steamSortByRecent]: "按最近游玩",
	[Key.steamNoGames]: "暂无游戏数据",
	[Key.steamNoGamesReason]: "可能的原因：Steam 个人资料未公开、API 限制或网络问题",
	[Key.steamConfigNeeded]: "需要配置 Steam API",
	[Key.steamConfigNeededReason]: "需要在环境变量中设置 STEAM_API_KEY 才能获取游戏数据",
	[Key.steamLastUpdated]: "数据更新于",
	[Key.steamNoRecentGames]: "最近没有玩过游戏",
	[Key.steamTotalGames]: "游戏总数",
	[Key.steamRecentPlaytime]: "近两周时长",
	[Key.steamLoading]: "加载中...",
	[Key.steamProfile]: "Steam 个人资料",
	[Key.steamTotalPlaytime]: "总游戏时长",
};
