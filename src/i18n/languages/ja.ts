...
export const ja: Translation = {
	...
	// Steam ゲームライブラリ
	[Key.steam]: "Steam ゲーム",
	[Key.steamRecentGames]: "最近プレイしたゲーム",
	[Key.steamGameLibrary]: "Steam ゲームライブラリ",
	[Key.steamLibrarySubtitle]: "私のSteamゲームの旅",
	[Key.steamViewFullLibrary]: "ライブラリ全体を見る",
	[Key.steamHours]: "時間",
	[Key.steamMinutes]: "分",
	[Key.steamLastPlayed]: "最終プレイ",
	[Key.steamNotPlayedRecently]: "最近プレイしていません",
	[Key.steamSortByPlaytime]: "プレイ時間順",
	[Key.steamSortByName]: "名前順",
	[Key.steamSortByRecent]: "最近順",
	[Key.steamNoGames]: "ゲームデータがありません",
	[Key.steamNoGamesReason]: "考えられる原因：Steamプロフィールが非公開、API制限、またはネットワークの問題",
	[Key.steamConfigNeeded]: "Steam API設定が必要",
	[Key.steamConfigNeededReason]: "ゲームデータを取得するには、環境変数STEAM_API_KEYを設定してください",
	[Key.steamLastUpdated]: "データ更新日",
	[Key.steamNoRecentGames]: "最近プレイしたゲームはありません",
	[Key.steamTotalGames]: "総ゲーム数",
	[Key.steamRecentPlaytime]: "直近2週間",
	[Key.steamLoading]: "読み込み中...",
	[Key.steamProfile]: "Steam プロフィール",
	[Key.steamTotalPlaytime]: "総プレイ時間",
};
