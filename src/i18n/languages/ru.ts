...
export const ru: Translation = {
	...
	// Steam библиотека игр
	[Key.steam]: "Steam игры",
	[Key.steamRecentGames]: "Недавно сыгранные",
	[Key.steamGameLibrary]: "Библиотека Steam",
	[Key.steamLibrarySubtitle]: "Моё игровое путешествие в Steam",
	[Key.steamViewFullLibrary]: "Посмотреть всю библиотеку",
	[Key.steamHours]: "ч.",
	[Key.steamMinutes]: "мин.",
	[Key.steamLastPlayed]: "Последняя игра",
	[Key.steamNotPlayedRecently]: "Не играл недавно",
	[Key.steamSortByPlaytime]: "По времени игры",
	[Key.steamSortByName]: "По названию",
	[Key.steamSortByRecent]: "По недавним",
	[Key.steamNoGames]: "Нет данных об играх",
	[Key.steamNoGamesReason]: "Возможные причины: профиль Steam закрыт, ограничение API или проблема с сетью",
	[Key.steamConfigNeeded]: "Требуется настройка Steam API",
	[Key.steamConfigNeededReason]: "Установите переменную окружения STEAM_API_KEY для получения данных об играх",
	[Key.steamLastUpdated]: "Данные обновлены",
	[Key.steamNoRecentGames]: "Нет недавних игр",
	[Key.steamTotalGames]: "Всего игр",
	[Key.steamRecentPlaytime]: "За последние 2 недели",
	[Key.steamLoading]: "Загрузка...",
	[Key.steamProfile]: "Профиль Steam",
	[Key.steamTotalPlaytime]: "Общее время игры",
};
