...
export const en: Translation = {
	...
	// Steam Game Library
	[Key.steam]: "Steam Games",
	[Key.steamRecentGames]: "Recently Played",
	[Key.steamGameLibrary]: "Steam Game Library",
	[Key.steamLibrarySubtitle]: "My Steam gaming journey",
	[Key.steamViewFullLibrary]: "View Full Library",
	[Key.steamHours]: "hours",
	[Key.steamMinutes]: "minutes",
	[Key.steamLastPlayed]: "Last Played",
	[Key.steamNotPlayedRecently]: "Not played recently",
	[Key.steamSortByPlaytime]: "By Playtime",
	[Key.steamSortByName]: "By Name",
	[Key.steamSortByRecent]: "By Recent",
	[Key.steamNoGames]: "No game data",
	[Key.steamNoGamesReason]: "Possible reasons: Steam profile is private, API limit, or network issue",
	[Key.steamConfigNeeded]: "Steam API Config Needed",
	[Key.steamConfigNeededReason]: "Set STEAM_API_KEY environment variable at build time to fetch game data",
	[Key.steamLastUpdated]: "Data updated at",
	[Key.steamNoRecentGames]: "No recently played games",
	[Key.steamTotalGames]: "Total Games",
	[Key.steamRecentPlaytime]: "Recent 2 Weeks",
	[Key.steamLoading]: "Loading...",
	[Key.steamProfile]: "Steam Profile",
	[Key.steamTotalPlaytime]: "Total Playtime",
};
