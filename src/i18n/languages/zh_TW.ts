...
export const zh_TW: Translation = {
	...
	// Steam 遊戲庫
	[Key.steam]: "Steam 遊戲",
	[Key.steamRecentGames]: "最近玩過",
	[Key.steamGameLibrary]: "Steam 遊戲庫",
	[Key.steamLibrarySubtitle]: "記錄我的 Steam 遊戲之旅",
	[Key.steamViewFullLibrary]: "查看完整遊戲庫",
	[Key.steamHours]: "小時",
	[Key.steamMinutes]: "分鐘",
	[Key.steamLastPlayed]: "最後遊玩",
	[Key.steamNotPlayedRecently]: "最近未遊玩",
	[Key.steamSortByPlaytime]: "按遊戲時長",
	[Key.steamSortByName]: "按名稱",
	[Key.steamSortByRecent]: "按最近遊玩",
	[Key.steamNoGames]: "暫無遊戲數據",
	[Key.steamNoGamesReason]: "可能的原因：Steam 個人資料未公開、API 限制或網絡問題",
	[Key.steamConfigNeeded]: "需要配置 Steam API",
	[Key.steamConfigNeededReason]: "需要在環境變量中設置 STEAM_API_KEY 才能獲取遊戲數據",
	[Key.steamLastUpdated]: "數據更新於",
	[Key.steamNoRecentGames]: "最近沒有玩過遊戲",
	[Key.steamTotalGames]: "遊戲總數",
	[Key.steamRecentPlaytime]: "近兩週時長",
	[Key.steamLoading]: "加載中...",
	[Key.steamProfile]: "Steam 個人資料",
	[Key.steamTotalPlaytime]: "總遊戲時長",
};
